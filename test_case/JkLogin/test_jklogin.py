...
TestData = CaseData(ConfigHandler.data_path + r'JkLogin/jklogin.yaml').case_process()
...
if __name__ == '__main__':
    pytest.main(['test_jklogin.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
