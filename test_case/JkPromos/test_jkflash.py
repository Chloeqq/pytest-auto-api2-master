...
TestData = CaseData(ConfigHandler.data_path + r'JkPromos/jkflash.yaml').case_process()
...
if __name__ == '__main__':
    pytest.main(['test_jkflash.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
