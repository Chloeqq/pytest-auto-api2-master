...
class ConfigHandler:
    ...
    log_path = os.path.join(root_path, 'logs' + _SLASH + f'log_{localtime}.log')

    info_log_path = os.path.join(root_path, 'logs' + _SLASH + f'info_{localtime}.log')

    error_log_path = os.path.join(root_path, 'logs' + _SLASH + f'error_{localtime}.log')

    warning_log_path = os.path.join(root_path, 'logs' + _SLASH + f'warning_{localtime}.log')

    config_path = os.path.join(root_path, 'common' + _SLASH + 'config.yaml')

    url_params_path = os.path.join(root_path, 'common' + _SLASH + 'urlparams.yaml')
